var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( oTable, nTr )
        {
            ...
            var sOut = '<table>';
            sOut += '<tr><td rowspan="5">'+aData[1]+'</td><td>Matricule :</td><td>'+aData[2]+'</td></tr>';
            sOut += '<tr><td>Nom :</td><td>'+aData[3]+'</td></tr>';
            sOut += '<tr><td>Tel :</td><td>'+aData[4]+'</td></tr>';
            sOut += '<tr><td>Roles :</td><td>'+aData[5]+'</td></tr>';
